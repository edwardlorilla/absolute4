                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <!--<div class="form-group">
                                    ...
                                    <input v-model="pr_number" required type="text"
                                           class="form-control form-control-sm"
                                           :class="errors.pr_number ? 'is-invalid' : ''"
                                           id="pr_number" name="pr_number"
                                           placeholder="pr_number">
                                    <span v-if="errors.pr_number" v-for="error in errors.pr_number" class="invalid-feedback" role="alert">
                                        <strong>{{ error }}</strong>
                                    </span>
                                </div>-->
                                <div class="el-form-item" :class="errors.source_id ? 'is-error is-required' : ''" >
                                    <div class="row">
                            ...
                            <button class="btn btn-default" type="button"
                                    @click="isAddSource = false">Cancel</button>
                                        ...
                                        <div v-if="errors.source_id" v-for="error in errors.source_id" class="el-form-item__error">
                                            {{error}}
                                        </div>
                                        </div>
                                </div>
                ...
                <form ref="form" @submit.prevent="onSubmit">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input min="1" required type="number" v-model="quantity"
                                               class="form-control form-control-sm"
                                               id="quantity"
                                    ...
                                    <!--<div class="form-group">
                                        ...
                                        <input required type="number" v-model="unit_cost"
                                               class="form-control form-control-sm"
                                               id="unit_cost"
                        ...
                        <div class="card-footer">
                            <button :disabled="!(source_select && quantity > 0 && po_number && date_delivered)"
        ...
        methods: {
            ...
            addSource(){
                ...
                axios.post(`/api/sources`, {name: vm.source_name}).then(function (response) {
                    ...
                    vm.sources = [{value: response.data, label: response.data.name}]
                    vm.source_select = response.data.id
                    vm.$message({message: response.statusText, type: 'success'})
            ...
            onSave(){
                var vm = this
                    var obj = {
                        ...
                        unit: vm.unit_id,
                        dispensing_unit: vm.dispensing_unit_id,
                        data: vm.supplies
                    }
                vm.errors = []

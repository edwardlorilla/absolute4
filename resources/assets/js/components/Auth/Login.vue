    ...
    <transition name="fade">
        <div v-if="show" class="login-box">
            <div class="login-logo">
                <div class="row">
                    <div class="col">
                        <img style="width: 66px;" src="/storage/images/b.png" alt="Davao City">
                    </div>
                    <div class="col">
                        <span class="brand-text font-weight-light">{{setting_d.name}}</span>
                    </div>
                    <div class="col">
                        <img style="width: 66px;" src="/storage/images/d.png" alt="City Health">
                    </div>
                </div>

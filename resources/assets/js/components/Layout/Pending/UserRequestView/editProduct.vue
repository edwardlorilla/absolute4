<template>
    <tr>
        ...
        <td>
            <el-input v-if="edit_" placeholder="Category Name" v-model="item.category_id" />
            <label v-else>{{item.category_id}}</label>
        </td>
        <!--<td>
            <el-input v-if="edit_" placeholder="Unit" v-model="item.package_id" />
            <label v-else>{{item.package_id}}</label>
        </td>-->
        <td>

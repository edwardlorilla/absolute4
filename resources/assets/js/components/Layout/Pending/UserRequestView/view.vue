        ...
        <data-tables-server v-if="nextPage || prevPage || !nextPage || !prevPage || meta"
            ...
            <el-table-column type="expand">
                <template slot-scope="props">
                    <component :is="props.row.data.type" :data="props.row.data"/>
                </template>
            </el-table-column>
            <el-table-column
                    label="ID"
...
<script>
    ...
    import supplyApproved from './../supply-approved.vue'
    import medicineApproved from './../medicine-approved.vue'
    ...
    export default {
        components:{
            ...
            'supply-approved' : supplyApproved,
            'medicine-approved' : medicineApproved
        },
        data() {
            var sortOrders = {}
            return {

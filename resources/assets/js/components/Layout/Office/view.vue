    ...
    <div v-if="data" class="dv">
        ...
        <div class="dv-header">
            ...
            <div class="dv-header-columns">
                ...
                <el-select size="mini" v-model="query.search_column" placeholder="Select">
                    <el-option label="All"
                               value="all"></el-option>
                    <el-option
            ...
            <div class="dv-header-operators">
                <el-select size="mini" v-model="query.search_operator" placeholder="Select">
                    <el-option
            ...
            <div class="dv-header-search">
                <el-input size="mini" placeholder="Search" @keyup.enter="loadData"
                          v-model="filters[0].value"></el-input>
            </div>
        </div>
        <div class="dv-header">
            <div class="dv-header-title">
                <el-button size="mini" type="success" @click="createPO">Add New Purchase Order No.</el-button>
                <el-button size="mini" type="primary" @click="receiveItem">Request Item</el-button>
        ...
        <data-tables-server v-if="nextPage || prevPage || !nextPage || !prevPage || meta"
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <span v-if="scope.row.reorder_point >= scope.row.quantity"
                          style="color:red;">{{scope.row.quantity}}</span>
...
<script>
    ...
    export default {
        ...
        beforeRouteEnter (to, from, next) {
            getData(to.meta.url  + '?type=0', to.query, (err, data) => {
        ...
        methods: {
            receiveItem(){
                var vm = this
                vm.$router.push({name: "requests.office-receive-item.create"})
            },
            requestSupply(){
                var vm = this
            ...
            _create(){
                let vm = this
                vm.$router.push({name: "supplies.create.office-supply"})
            },
            sortBy: function (key) {
                this.sortKey = key

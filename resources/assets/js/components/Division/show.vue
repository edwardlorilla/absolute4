<template>
    <div v-if="data" class="dv">
       <!-- <ul class="nav justify-content-center">
            <li class="nav-item">
                <router-link  class="nav-link" :to="{ name: 'divisions.show'}">Medical Receipts</router-link>
            </li>
            <li class="nav-item">
                <router-link class="nav-link" :to="{  name:'divisions.show.office'}">Supplies Receipts</router-link>
        ...
        methods: {
            ...
            setData (err, data) {
                ...
                if (err) {
                    ...
                    console.log(data)
                    vm.data = data.data.model.data[0].receipts;
                    console.log(vm.data)
